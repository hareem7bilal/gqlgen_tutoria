...
func (l *UserSliceLoader) Load(key string) (*models.User, error) {
...
func (l *UserSliceLoader) LoadThunk(key string) func() (*models.User, error) {
	l.mu.Lock()
...
func (l *UserSliceLoader) LoadAll(keys []string) ([]*models.User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserSliceLoader) LoadAllThunk(keys []string) func() ([]*models.User, []error) {
	results := make([]func() (*models.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserSliceLoader) Prime(key string, value *models.User) bool {
	l.mu.Lock()
	var found bool
...
func (l *UserSliceLoader) unsafeSet(key string, value *models.User) {
	if l.cache == nil {
